  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <label className="flex items-center gap-3 rounded-xl border border-border-hover bg-card p-3 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">User must verify their email</p>
          </div>
        </label>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-border-hover bg-card p-3 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">User must verify college ID</p>
          </div>
        </label>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-border-hover bg-card p-3 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">User must verify employment</p>
          </div>
        </label>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-border-hover bg-card p-3 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">Require a valid invite code</p>
          </div>
        </label>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-border-hover bg-card p-3 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">Quiz requires a password</p>
          </div>
        </label>
      </div>
      ...
      {restrictions.inviteCode && (
        <div className="space-y-1">
          ...
          <input type="text" value={restrictions.inviteCode || ""} onChange={(e) => updateString("inviteCode", e.target.value)} placeholder="Enter invite code" className="w-full h-9 rounded-lg border border-border-hover bg-card px-3 text-xs text-white focus:border-[#EC4899] focus:outline-none" />
        </div>
      )}
      ...
      {restrictions.password && (
        <div className="space-y-1">
          ...
          <input type="password" value={restrictions.password || ""} onChange={(e) => updateString("password", e.target.value)} placeholder="Enter quiz password" className="w-full h-9 rounded-lg border border-border-hover bg-card px-3 text-xs text-white focus:border-[#EC4899] focus:outline-none" />
        </div>
      )}

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1">
          <label className="text-xs font-medium text-muted-foreground">Minimum XP</label>
          <input type="number" value={restrictions.minXP ?? ""} onChange={(e) => updateNumber("minXP", e.target.value)} placeholder="e.g. 500" className="w-full h-9 rounded-lg border border-border-hover bg-card px-3 text-xs text-white focus:border-[#EC4899] focus:outline-none" />
        </div>

        <div className="space-y-1">
          <label className="text-xs font-medium text-muted-foreground">Minimum Rating</label>
          <input type="number" value={restrictions.minRating ?? ""} onChange={(e) => updateNumber("minRating", e.target.value)} placeholder="e.g. 1200" className="w-full h-9 rounded-lg border border-border-hover bg-card px-3 text-xs text-white focus:border-[#EC4899] focus:outline-none" />
        </div>
      </div>
    </motion.div>
  );
