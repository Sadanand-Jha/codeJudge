    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <label className="flex items-center gap-3 rounded-xl border border-white/[0.08] bg-[#111827] p-3 cursor-pointer">
          <input type="checkbox" checked={restrictions.verifiedEmail} onChange={() => toggle("verifiedEmail")} className="h-4 w-4 rounded border-white/20 bg-[#0B0D12] accent-[#7C3AED]" />
          <div>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-white/[0.08] bg-[#111827] p-3 cursor-pointer">
          <input type="checkbox" checked={restrictions.verifiedCollege} onChange={() => toggle("verifiedCollege")} className="h-4 w-4 rounded border-white/20 bg-[#0B0D12] accent-[#7C3AED]" />
          <div>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-white/[0.08] bg-[#111827] p-3 cursor-pointer">
          <input type="checkbox" checked={restrictions.verifiedCompany} onChange={() => toggle("verifiedCompany")} className="h-4 w-4 rounded border-white/20 bg-[#0B0D12] accent-[#7C3AED]" />
          <div>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-white/[0.08] bg-[#111827] p-3 cursor-pointer">
          <input type="checkbox" checked={!!restrictions.inviteCode} onChange={() => toggle("inviteCode")} className="h-4 w-4 rounded border-white/20 bg-[#0B0D12] accent-[#7C3AED]" />
          <div>
        ...
        <label className="flex items-center gap-3 rounded-xl border border-white/[0.08] bg-[#111827] p-3 cursor-pointer">
          <input type="checkbox" checked={!!restrictions.password} onChange={() => toggle("password")} className="h-4 w-4 rounded border-white/20 bg-[#0B0D12] accent-[#7C3AED]" />
          <div>
      ...
      {restrictions.inviteCode && (
        <div className="space-y-1">
          ...
          <input type="text" value={restrictions.inviteCode || ""} onChange={(e) => updateString("inviteCode", e.target.value)} placeholder="Enter invite code" className="w-full h-9 rounded-lg border border-white/[0.08] bg-[#111827] px-3 text-xs text-white focus:border-[#7C3AED] focus:outline-none" />
        </div>
      )}
      ...
      {restrictions.password && (
        <div className="space-y-1">
          ...
          <input type="password" value={restrictions.password || ""} onChange={(e) => updateString("password", e.target.value)} placeholder="Enter quiz password" className="w-full h-9 rounded-lg border border-white/[0.08] bg-[#111827] px-3 text-xs text-white focus:border-[#7C3AED] focus:outline-none" />
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          <input type="number" value={restrictions.minXP ?? ""} onChange={(e) => updateNumber("minXP", e.target.value)} placeholder="e.g. 500" className="w-full h-9 rounded-lg border border-white/[0.08] bg-[#111827] px-3 text-xs text-white focus:border-[#7C3AED] focus:outline-none" />
        </div>

        <div className="space-y-1">
          <label className="text-xs font-medium text-[#9CA3AF]">Minimum Rating</label>
          <input type="number" value={restrictions.minRating ?? ""} onChange={(e) => updateNumber("minRating", e.target.value)} placeholder="e.g. 1200" className="w-full h-9 rounded-lg border border-white/[0.08] bg-[#111827] px-3 text-xs text-white focus:border-[#7C3AED] focus:outline-none" />
        </div>
      </div>
    </motion.div>
  );
