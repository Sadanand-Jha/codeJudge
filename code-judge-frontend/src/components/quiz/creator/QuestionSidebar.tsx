...
export default function QuestionSidebar({
  ...
  return (
    <aside className="w-[280px] shrink-0 border-r border-white/[0.06] bg-[#0B0D14] flex flex-col h-full">
      {/* Header stats */}
      <div className="px-4 pt-4 pb-3 border-b border-white/[0.06]">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-[9px] text-[#71717A]">{completedCount}/{questions.length} done</span>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-3">
          <div className="px-2 py-1.5 rounded-lg bg-white/[0.03] border border-white/[0.06] text-center">
            <p className="text-[10px] font-bold text-white">{questions.length}</p>
            <p className="text-[8px] text-[#71717A]">Total</p>
          </div>
          <div className="px-2 py-1.5 rounded-lg bg-white/[0.03] border border-white/[0.06] text-center">
            ...
            <p className="text-[8px] text-[#71717A]">Duration</p>
          </div>
          <div className="px-2 py-1.5 rounded-lg bg-white/[0.03] border border-white/[0.06] text-center">
            <p className="text-[10px] font-bold text-white flex items-center justify-center gap-0.5">
            ...
            <p className="text-[8px] text-[#71717A]">Marks</p>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-8 rounded-lg border border-white/[0.06] bg-[#111217] pl-8 pr-3 text-[11px] text-white placeholder-[#6B7280] focus:outline-none focus:border-[#EC4899]/30 transition-colors"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        ...
                        <span className="text-[9px] text-[#71717A] truncate">{QUESTION_TYPE_LABELS[q.type]}</span>
                      ...
                      <AnimatePresence>
                        {isMenuOpen && (
                          <motion.div
                            ...
                            className="absolute right-0 top-full z-50 mt-1 w-36 rounded-xl border border-white/[0.08] bg-[#111217] shadow-2xl shadow-black/50 overflow-hidden"
        ...
        {filtered.length === 0 && (
          <div className="text-center py-8">
            <p className="text-xs text-[#71717A]">No questions found</p>
          </div>
        )}
      </div>
