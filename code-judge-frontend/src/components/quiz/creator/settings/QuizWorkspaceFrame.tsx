          ...
          <div className="mt-6">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                />
                <span className={cn("font-medium", inProblems && "font-semibold")}>Problems</span>
                {problems.length > 0 && (
        ...
        {inProblems && (
          ...
          >
            <div className="border-b border-border p-4">
              ...
              <p className="mt-1 text-[10px] text-text-muted">{problems.length} total</p>
            </div>
