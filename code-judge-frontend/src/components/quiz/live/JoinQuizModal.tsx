    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="relative rounded-3xl border border-white/[0.12] bg-gradient-to-br from-[#111217] to-[#0B0D14] p-6 shadow-2xl shadow-black/60">
              <div className="absolute -inset-0.5 rounded-3xl bg-gradient-to-r from-[#EC4899] to-[#BE185D] opacity-20 blur" />
              <div className="relative">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2.5">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#EC4899] to-[#BE185D] flex items-center justify-center">
                      <Sparkles className="w-5 h-5 text-white" />
                    </div>
                    <h2 className="text-lg font-bold text-white">Join Quiz</h2>
                  </div>
                  <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-white/[0.06] text-[#9CA3Af] hover:text-white transition-colors">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <motion.button
                  ...
                  disabled={!valid}
                  className="w-full mt-5 h-10 rounded-xl bg-gradient-to-r from-[#EC4899] to-[#BE185D] text-xs font-bold text-white hover:shadow-[0_0_20px_rgba(236,72,153,0.3)] transition-all flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  Join Quiz
                </motion.button>
              </div>
