...
/**
 * Section 5 — Waiting Room Cosmetics (Light Theme)
 * A floating futuristic campus with glass avatar cards,
 * soft colorful halos, floating reaction bubbles and gradient lighting.
 */
export default function LightWaitingRoomSection({ progress }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_20%_80%,rgba(168,85,247,0.05),transparent_50%)]" />
      ...
      <div className="relative h-[480px] w-full max-w-5xl">
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{ background: `radial-gradient(circle, ${avatar.border}44, transparent 70%)` }}
              />

              {/* Glass avatar card */}
              <div
                className="relative flex h-14 w-14 items-center justify-center rounded-full border-2 text-lg font-bold text-white shadow-lg backdrop-blur-md sm:h-16 sm:w-16"
                style={{
                  background: `linear-gradient(135deg, ${avatar.color}, ${avatar.color}cc)`,
                  borderColor: avatar.border,
                  boxShadow: `0 4px 20px ${avatar.border}33`,
                }}
              >
                {avatar.initial}
                ...
                {/* Decoration badge */}
                <div
                  className="absolute -top-2 -right-2 flex h-6 w-6 items-center justify-center rounded-full border border-white/60 bg-white"
                  style={{ color: avatar.border, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}
                >
              ...
              <div
                ...
                style={{
                  background: `${avatar.color}1a`,
                  color: avatar.border,
                  border: `1px solid ${avatar.border}22`,
                }}
              >
                {avatar.name}
              </div>
        ...
        >
          <div className="absolute -inset-2 rounded-full bg-[radial-gradient(circle,rgba(236,72,153,0.3),transparent_70%)] blur-md" />
          <div className="relative flex h-16 w-16 items-center justify-center rounded-full border-2 border-[#EC4899] bg-gradient-to-br from-[#EC4899] to-[#8B5CF6] text-xl font-bold text-white shadow-[0_4px_24px_rgba(236,72,153,0.4)]">
            Z
          </div>
          <div className="mt-2 rounded-full border border-[#EC4899]/30 bg-white/80 px-2.5 py-0.5 text-[10px] font-bold text-[#EC4899] backdrop-blur-sm shadow-[0_2px_8px_rgba(236,72,153,0.1)]">
            Zoya joined!
          </div>
        </motion.div>
