...
export function AiAssistantPanel({
  ...
  return (
    <div className="flex shrink-0 flex-col border-l border-border bg-card/50">
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-1.5">
          ...
          {AI_ACTIONS.map((a) => (
            <button
              ...
              onClick={() => run(a.id)}
              disabled={!!working}
              className="w-full text-left rounded-xl border border-border p-2.5 text-left transition-colors hover:border-pink-500/30 hover:bg-white/[0.03]"
            >
