...
// Dummy rooms commented out — now using backend implementation for rooms (see src/services/rooms.ts + backend quiz_rooms/room_members).
// Mock data retained for reference but not used. Uncomment to re-enable local demo data.
