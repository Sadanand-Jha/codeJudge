          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-card-hover">
                <th className="text-left text-[10px] font-medium uppercase tracking-wider text-text-secondary px-4 py-3">ID</th>
                <th className="text-left text-[10px] font-medium uppercase tracking-wider text-text-secondary px-4 py-3">Problem</th>
                <th className="text-left text-[10px] font-medium uppercase tracking-wider text-text-secondary px-4 py-3">Verdict</th>
                <th className="text-right text-[10px] font-medium uppercase tracking-wider text-text-secondary px-4 py-3">Time</th>
              </tr>
            </thead>
            <tbody>
              <tr>
