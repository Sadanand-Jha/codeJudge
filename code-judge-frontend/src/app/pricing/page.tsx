...
const plans = [
  {
    name: "Free",
    price: "$0",
    features: ["Access to all problems", "Up to 2 quizzes per day","Basic submissions", "Community support"],
    current: true,
    color: "#9CA3AF",
  },
  {
    name: "Pro",
    price: "$10/mo",
    features: ["Everything in Free", "AI Support", "Up to 5 quizzes per day","Detailed analytics","Up to 2 collaborators per quiz", "Priority support"],
    current: false,
    color: "#7C3AED",
  },
  {
    name: "Team",
    price: "$29/mo",
    features: ["Everything in Pro", "Team leaderboards", "10 quizzes per day", "Up to 10 collaborators per quiz", "Custom contests", "Admin dashboard"],
    current: false,
    color: "#3B82F6",
  },
];
