      ...
      <div className="px-6 py-6">
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="p-6">
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-[#9CA3AF]">Register to participate in this contest</p>
                </div>
              </div>
          ...
          >
            ...
            {/* Rated toggle */}
            <div className="mt-6 rounded-xl border border-white/[0.06] bg-[#0B0D12] p-4">
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <p className="text-sm font-medium text-white">Rated Contest</p>
                  <p className="text-xs text-[#9CA3AF]">Your rating will be affected by your performance</p>
                </div>
                <button
            ...
            <div className="mt-4 space-y-3">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="text-sm text-[#9CA3AF]">I have read and understood all the contest rules</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <button
                ...
                <span className="text-sm text-[#9CA3AF]">I agree to participate in this contest</span>
              </label>
            </div>
