    ...
    <div className="min-h-screen bg-[#09090B] flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-[#111827] p-6">
          ...
          <p className="text-xs text-[#9CA3AF] text-center mb-6">Start your coding journey</p>

          <form className="space-y-4" onSubmit={submit}>
            <div>
              <label className="block text-[11px] font-medium text-[#9CA3AF] mb-2">Username</label>
          ...
          <div className="mt-5 text-center text-xs text-[#6B7280]">
            ...
            <Link href="/login" className="text-[#7C3AED] hover:underline">Sign in</Link>
          </div>
        </div>
      </div>
    </div>
