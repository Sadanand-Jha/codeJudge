...
var problem_repository_ts_1 = require("../repositories/problem.repository.ts");
var index_ts_1 = require("../types/index.ts");
var ProblemService = /** @class */ (function () {
    function ProblemService() {
        this.repository = new problem_repository_ts_1.ProblemRepository();
    }
    /**
    ...
    ProblemService.prototype.getAllProblems = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.repository.getAllProblems()];
            });
        });
    };
    /**
     ...
     */
    ProblemService.prototype.getProblemByProblemId = function (problemId) {
        return __awaiter(this, void 0, void 0, function () {
            var problem;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getProblemByProblemId(problemId)];
                    case 1:
                        problem = _a.sent();
                        if (!problem) {
                            throw new index_ts_1.NotFoundError("Problem with ID \"".concat(problemId, "\" not found"));
                        }
